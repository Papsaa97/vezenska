...
export const sluzebniPripravaQuestions: Question[] = [
  ...
  },
  {
    ...
    "explanation": "Paragraf 18 odst. 1 zákona č. 555/1992 Sb. taxativně vymezuje přesně 5 důvodů použití střelné zbraně pod písmeny a) až e). Použití zbraně je přípustné pouze tehdy, jestliže použití donucovacích prostředků by bylo zřejmě neúčinné (odst. 2). (Právní úprava: § 18 odst. 1 zákona č. 555/1992 Sb., o VS a JS ČR)"
  },
  {
    "id": "sp-03",
    "subject": "Služební příprava",
    ...
    "explanation": "Katalog DP v § 17 zákona č. 555/1992 Sb. je taxativní. Příslušník smí použít pouze zákonem schválené donucovací prostředky a musí volit ten nejmírnější, který postačí k dosažení účelu zákroku (subsidiarita). (Právní úprava: § 17 zákona č. 555/1992 Sb., o VS a JS ČR)"
  },
  {
    "id": "sp-04",
    "subject": "Služební příprava",
  ...
  },
  {
    ...
    "explanation": "Zákon č. 555/1992 Sb. v § 20 striktně ukládá povinnost poskytnout první pomoc, zajistit lékařské vyšetření a bezodkladně podat písemné hlášení o každém použití DP nebo zbraně řediteli věznice. (Právní úprava: § 20 zákona č. 555/1992 Sb., o VS a JS ČR)"
  },
  {
    "id": "sp-10",
    "subject": "Služební příprava",
  ...
  },
  {
    ...
    "explanation": "Zajištění pojistky (Double Lock) zabrání svévolnému utažení pout při pohybu osoby (prevence poškození nervů a cév) i snadnému vyhmatání západky. (Právní úprava: Metodika použití donucovacích prostředků – Poutací technika VS ČR (Kupec))"
  },
  {
    "id": "sp-15",
    "subject": "Služební příprava",
    ...
    "explanation": "Drill Tap-Rack odstraní 90 % běžných zádržek pistole (nedoražený zásobník, selhač zápalky, nevytáhnutá nábojnice). Provádí se automaticky během zlomku sekundy. (Právní úprava: Předpis pro střeleckou přípravu a taktiku VS ČR)"
  },
  {
    "id": "sp-16",
    "subject": "Služební příprava",
  ...
  },
  {
    ...
    "explanation": "Správná imobilizace znehybněním obou přilehlých kloubů brání posunu úlomků, sekundárnímu poškození cév a nervů a tiší traumatickou bolest. (Právní úprava: Výukové standardy první pomoci Akademie VS ČR)"
  },
  {
    "id": "sp-22",
    "subject": "Služební příprava",
    ...
    "explanation": "Taktické přebití umožňuje příslušníkovi doplnit maximální kapacitu střeliva v klidnější fázi kontaktu, aniž by ztratil náboj v komoře nebo zahodil zbývající munici. (Právní úprava: Předpis střelecké přípravy a taktiky VS ČR)"
  },
  {
    "id": "sp-23",
    "subject": "Služební příprava",
    ...
    "explanation": "Zákon č. 555/1992 Sb. v § 7 odst. 2 taxativně stanoví tři důvody zproštění povinnosti provést služební zákrok. Příslušník však musí učinit jiná opatření k zajištění zákroku (např. ihned volat nadřízeného). (Právní úprava: § 7 odst. 2 zákona č. 555/1992 Sb.)"
  },
  {
    "id": "sp-24",
    "subject": "Služební příprava",
    ...
    "explanation": "Dle § 8 zákona č. 555/1992 Sb. prokazuje příslušník příslušnost průkazem nebo stejnokrojem s ID číslem. Ústní prohlášení „Vězeňská služba“ je vyhrazeno pro naléhavé zákroky, kde to okolnosti neumožňují. (Právní úprava: § 8 zákona č. 555/1992 Sb. a vyhláška č. 166/2014 Sb.)"
  },
  {
    "id": "sp-25",
    "subject": "Služební příprava",
    ...
    "explanation": "Nutná obrana (§ 29 TZ) opravňuje k odvrácení útoku. Obrana může být intenzivnější než útok (musí útok odrazit), nesmí však být zcela zjevně nepřiměřená (exces intenzivní) a útok musí trvat nebo bezprostředně hrozit (exces extenzivní). (Právní úprava: § 29 zákona č. 40/2009 Sb., trestní zákoník)"
  },
  {
    "id": "sp-26",
    "subject": "Služební příprava",
    ...
    "explanation": "U krajní nouze (§ 28 TZ) se odvrací nebezpečí a způsobený následek musí být menší než hrozící. U nutné obrany (§ 29 TZ) se odvrací lidský útok a obrana může být i důraznější než útok. (Právní úprava: § 28 a § 29 zákona č. 40/2009 Sb.)"
  },
  {
    "id": "sp-27",
    "subject": "Služební příprava",
    ...
    "explanation": "Dle § 80 odst. 2 písm. c) NGŘ č. 33/2019 ve znění 8/2022 jsou stanovení ústavní činitelé, soudci, státní zástupci a kontrolní orgány osvobozeni od kontroly a prohlídky zavazadel při vstupu do věznice. (Právní úprava: § 80 odst. 2 písm. c) NGŘ č. 33/2019)"
  },
  {
    "id": "sp-28",
    "subject": "Služební příprava",
    ...
    "explanation": "Katalog oprávnění ke vstupu je taxativně vymezen v § 103 až 112 NGŘ č. 33/2019. Vstup na potvrzení o ztrátě OP je možný pouze s jiným platným dokladem s fotografií. (Právní úprava: § 103–112 NGŘ č. 33/2019)"
  },
  {
    "id": "sp-29",
    "subject": "Služební příprava",
    ...
    "explanation": "Silné elektromagnetické pole detektoru by mohlo vyvolat interferenci. Na základě předložené karty implantátu se provede šetrná ruční kontrola oděvu. (Právní úprava: Metodika činnosti VS ČR na vchodech a vjezdech 2020)"
  },
  {
    "id": "sp-30",
    "subject": "Služební příprava",
    ...
    "source": "Metodika činnosti VS ČR na vchodech a vjezdech 2020",
    "explanation": "Detektor tepové frekvence zachycuje mikrovibrace karoserie způsobené tlukotem srdce ukryté osoby. Jakýkoliv pohyb motoru, větru otevřeným oknem nebo přítomnost posádky by zmařily měření. (Právní úprava: Metodika činnosti VS ČR na vchodech a vjezdech 2020)"
  },
  {
    "id": "sp-31",
    "subject": "Služební příprava",
    ...
    "explanation": "Dle § 144 odst. 6 NGŘ č. 33/2019 a Instrukce MS č. 8/2022 má příslušník JS obě ruce volné pro okamžité použití donucovacích prostředků nebo zbraně a nikdy se nedotýká přepravovaných peněz. (Právní úprava: § 144 odst. 6 NGŘ č. 33/2019 a Instrukce MS č. 8/2022)"
  },
  {
    "id": "sp-32",
    "subject": "Služební příprava",
    ...
    "explanation": "Příslušník JS plní výhradně roli ozbrojené ochrany vykonavatele. Nesmí provádět samotný výkon soudního rozhodnutí ani zasahovat do práv nad rámec odvrácení fyzického útoku. (Právní úprava: § 143 NGŘ č. 33/2019 a Instrukce MS č. 8/2022)"
  },
  {
    "id": "sp-33",
    "subject": "Služební příprava",
  ...
  },
  {
    ...
    "explanation": "Zákon č. 361/2003 Sb. a NGŘ č. 38/2018 přesně vymezují hodnostní stupně a jejich grafické provedení na náramenících. (Právní úprava: Zákon č. 361/2003 Sb. a NGŘ č. 38/2018)"
  },
  {
    "id": "sp-35",
    "subject": "Služební příprava",
    ...
    "explanation": "V situacích, kde by salutování nebo podávání hlášení mohlo ohrozit bezpečnost, způsobit nehodu nebo přerušit taktický zákrok, je zdravení výslovně zakázáno. (Právní úprava: Čl. 11 NGŘ č. 38/2018 o pravidlech služební zdvořilosti)"
  },
  {
    "id": "sp-36",
    "subject": "Služební příprava",
    ...
    "explanation": "Při úmrtí na eskortě je nutné protokolární ohledání lékařem RZS/koronerem, zajištění osobních věcí a okamžité vyrozumění ředitele věznice a Policie ČR k vyloučení cizího zavinění. (Právní úprava: § 73 NGŘ č. 33/2019 a metodika eskort (Kupec))"
  },
  {
    "id": "sp-37",
    "subject": "Služební příprava",
    ...
    "explanation": "Zatímco STH určuje lékař, NMU psycholog a MON/MPN schvaluje VOVT, o kategoriích DVO (medializované kauzy) a DVO-P (bývalí příslušníci ozbrojených sborů) rozhoduje výhradně ředitel věznice. (Právní úprava: § 8 a § 9 NGŘ č. 24/2022)"
  },
  {
    "id": "sp-38",
    "subject": "Služební příprava",
    ...
    "explanation": "Přiložení pout na nohy přes textil umožňuje snadné vyvlečení látky a získání dostatečné vůle pro běh či útok. Pouta se přikládají na holou nohu s aktivací pojistky a zámky směřujícími k zemi. (Právní úprava: Metodická příručka poutání ve VS ČR (Kupec))"
  },
  {
    "id": "sp-39",
    "subject": "Služební příprava",
    ...
    "options": [
      ...
      "Části A až C (výhradně osobní údaje a datum zákroku), zatímco popis průběhu a grafické schéma zranění vyplňuje vyšetřovatel PČR."
    ],
    "correctOption": 0,
    ...
    "explanation": "Dle Metodického listu č. 5/2014 má formulář 13 částí A–M. Zakročující příslušník zpracovává části A až G ve 2 výtiscích bez zbytečného odkladu. (Právní úprava: § 4 Metodického listu ředitele odboru VaJS č. 5/2014)"
  },
  {
    "id": "sp-40",
    "subject": "Služební příprava",
    ...
    "options": [
      ...
      "Pouta lze použít výhradně se souhlasem ředitele věznice v případě, že vězeň odmítá pracovat."
    ],
    "correctOption": 1,
    ...
    "source": "§ 17 zákona č. 555/1992 Sb., o VS a JS ČR",
    "explanation": "Zákon č. 555/1992 Sb. taxativně vyjmenovává situace pro použití pout, mezi které patří zejména zamezení útěku, sebepoškozování, napadání okolí a zajištění bezpečnosti při předvádění a eskortách. (Právní úprava: § 17 zákona č. 555/1992 Sb., o VS a JS ČR)"
  },
  {
    "id": "sp-41",
    "subject": "Služební příprava",
    ...
    "correctOption": 1,
    "rationale": "Zákon jasně chrání vybrané zranitelné skupiny. Výjimka pro použití DP vůči nim platí POUZE tehdy, pokud útok těchto osob bezprostředně ohrožuje život nebo zdraví jiných a nelze jej odvrátit jinak (§ 19 zákona č. 555/1992 Sb.).",
    "source": "§ 19 zákona č. 555/1992 Sb., o VS a JS ČR",
    "explanation": "Zákon jasně chrání vybrané zranitelné skupiny. Výjimka pro použití DP vůči nim platí POUZE tehdy, pokud útok těchto osob bezprostředně ohrožuje život nebo zdraví jiných a nelze jej odvrátit jinak (§ 19 zákona č. 555/1992 Sb.). (Právní úprava: § 19 zákona č. 555/1992 Sb., o VS a JS ČR)"
  },
  {
    "id": "sp-42",
    "subject": "Služební příprava",
    ...
    "explanation": "Toto pravidlo (spolu s mířením do bezpečného prostoru a prstem mimo spoušť) tvoří celosvětový standard pro prevenci nechtěných výstřelů a fatálních zranění při manipulaci. (Právní úprava: Předpis pro střeleckou přípravu a bezpečnost manipulace se zbraněmi)"
  },
  {
    "id": "sp-43",
    "subject": "Služební příprava",
    ...
    "explanation": "Kontrola zbraně a vytvoření bezpečné vzdálenosti/úhlu je klíčové pro přežití útoku bodnou zbraní. Snaha o disarm (vytržení) před plnou kontrolou pohybu vede k těžkým řezným poraněním. (Právní úprava: Metodika taktické sebeobrany Akademie VS ČR)"
  },
  {
    "id": "sp-44",
    "subject": "Služební příprava",
    ...
    "explanation": "Technologie NMI přeruší komunikaci mezi mozkem a svaly (bez ohledu na toleranci bolesti pachatele např. z drog). Po vypnutí cyklu se motorická funkce okamžitě vrací k normálu. (Právní úprava: § 17 zákona č. 555/1992 Sb. a manuál výrobce)"
  },
  {
    "id": "sp-45",
    "subject": "Služební příprava",
    ...
    "correctOption": 1,
    "rationale": "Bezpečný prostor je prostor, kde směřování hlavně vylučuje zranění osob nebo nebezpečný odraz střely při nechtěném výstřelu (typicky certifikovaný lapač střel).",
    "source": "Předpis o střelecké přípravě a zbraňové službě VS ČR",
    "explanation": "Bezpečný prostor vylučuje zranění osob nebo odraz střely při nechtěném výstřelu."
  },
  {
    "id": "sp-46",
    "subject": "Služební příprava",
    "topic": "Zákonné podmínky užití zbraně",
    "question": "Jaká povinnost příslušníka VS ČR předchází použití zbraně podle § 18 odst. 3 zákona č. 555/1992 Sb., je-li to s ohledem na okolnosti možné?",
    ...
    "correctOption": 0,
    "rationale": "Dle § 18 odst. 3 zákona č. 555/1992 Sb. je příslušník před použitím zbraně povinen, je-li to s ohledem na okolnosti případu možné, vyzvat osobu k upuštění od jednání s výstrahou použití zbraně a použít výstražný výstřel.",
    "source": "§ 18 odst. 3 zákona č. 555/1992 Sb., o VS a JS ČR",
    "explanation": "Před použitím zbraně je příslušník povinen vyzvat osobu s výstrahou a užít výstražného výstřelu, dovolují-li to okolnosti. (Právní úprava: § 18 odst. 3 zákona č. 555/1992 Sb., o VS a JS ČR)"
  },
  {
    "id": "sp-47",
    "subject": "Služební příprava",
