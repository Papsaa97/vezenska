...
export const zdravovedaQuestions: Question[] = [
  {
    ...
    source: 'TCCC Guidelines & Standardy neodkladné první pomoci Akademie VS ČR',
      explanation: `Masivní tepenné krvácení je nejčastější odvratitelnou příčinou smrti v taktickém a bezpečnostním prostředí. Algoritmus TCCC (bod M - Massive Bleeding) vyžaduje okamžitou aplikaci turniketu s řádným dotažením a označením času naložení. (Právní úprava: TCCC Guidelines & Standardy neodkladné první pomoci Akademie VS ČR)`
},
  {
    id: 'zdr-02',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Doporučené postupy ERC (European Resuscitation Council)',
      explanation: `Doporučené postupy Evropské resuscitační rady (ERC) stanovují univerzální poměr 30:2 u dospělých. V případě neochoty či nemožnosti dýchat (např. riziko infekce u vězně) se provádí nepřerušovaná kvalitní masáž srdce frekvencí 100–120/min. (Právní úprava: Doporučené postupy ERC (European Resuscitation Council))`
},
  {
    id: 'zdr-03',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'ERC Guidelines – Resuscitation with AED & Metodika VS ČR',
      explanation: `AED je bezpečný poloautomatický přístroj, který sám vyhodnotí fibrilaci komor či bezpulzovou komorovou tachykardii a instruuje zachránce. Včasná defibrilace během prvních 3–5 minut zvyšuje šanci na přežití až na 70 %. (Právní úprava: ERC Guidelines – Resuscitation with AED & Metodika VS ČR)`
},
  {
    id: 'zdr-04',
    subject: 'Zdravověda a první pomoc',
...
},
  {
    ...
    source: 'TCCC Guidelines & Traumatologie v neodkladné péči',
      explanation: `Otevřený pneumotorax může rychle přejít v tenzní (přetlakový) pneumotorax se stlačením srdce a velkých cév. Chlopňové krytí působí jako jednosměrný ventil. (Právní úprava: TCCC Guidelines & Traumatologie v neodkladné péči)`
},
  {
    id: 'zdr-06',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Standardy první pomoci ČČK a ERC',
      explanation: `Zotavovací poloha chrání dýchací cesty před obstrukcí a aspirací žaludečního obsahu u bezvědomého. Stav dýchání se musí nepřetržitě kontrolovat. (Právní úprava: Standardy první pomoci ČČK a ERC)`
},
  {
    id: 'zdr-07',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Toxikologie a neodkladná péče ve vězeňství VS ČR',
      explanation: `Opioidy tlumí dechové centrum v prodloužené míše. Naloxon je specifický opioidní antagonista, který vyváže receptory a obnoví spontánní dýchání během 2–3 minut. (Právní úprava: Toxikologie a neodkladná péče ve vězeňství VS ČR)`
},
  {
    id: 'zdr-08',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'První pomoc při neurologických urgentních stavech',
      explanation: `Násilné vkládání předmětů do úst vede k vylomení zubů a ucpání dýchacích cest. Základem je ochrana hlavy před nárazy a sledování průchodnosti dýchacích cest po záchvatu. (Právní úprava: První pomoc při neurologických urgentních stavech)`
},
  {
    id: 'zdr-09',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Doporučené postupy České společnosti alergologie a klinické imunologie',
      explanation: `Adrenalin (epinefrin) intramuskulárně do anterolaterální strany stehna zužuje cévy, zvyšuje tlak a rozšiřuje dýchací cesty. Včasné podání zachraňuje život před udušením otokem hrtanu. (Právní úprava: Doporučené postupy České společnosti alergologie a klinické imunologie)`
},
  {
    id: 'zdr-10',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Národní doporučený postup pro iktovou péči v ČR',
      explanation: `Při ischemické mozkové příhodě rozhoduje časové okno pro trombolýzu (ideálně do 4,5 hodiny od prvních příznaků). Test FAST umožňuje laickému zachránci okamžité rozpoznání. (Právní úprava: Národní doporučený postup pro iktovou péči v ČR)`
},
  {
    id: 'zdr-11',
    subject: 'Zdravověda a první pomoc',
...
},
  {
    ...
    source: 'Metodický pokyn Hlavního hygienika ČR a zdravotnické služby VS ČR',
      explanation: `Včasné zahájení postexpoziční profylaxe (PEP) proti HIV do několika hodin po expozici dramaticky snižuje riziko sérokonverze. Současně se odebírají nulté vzorky krve a kontroluje se očkování proti žloutence B. (Právní úprava: Metodický pokyn Hlavního hygienika ČR a zdravotnické služby VS ČR)`
},
  {
    id: 'zdr-14',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'TCCC Guidelines – Junctional Bleeding Management',
      explanation: `V junkčních oblastech (třísla, axily) je wound packing jedinou účinnou metodou přímého stlačení poraněné cévy v hloubce rány. Na krk je aplikace škrtidla přísně zakázána. (Právní úprava: TCCC Guidelines – Junctional Bleeding Management)`
},
  {
    id: 'zdr-15',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Traumatologie páteře a urgentní medicína',
      explanation: `Nevhodná manipulace může vést k posunu nestabilního obratle a nevratnému přerušení míchy s následným ochrnutím (kvadruplegií) nebo zástavou dechu. (Právní úprava: Traumatologie páteře a urgentní medicína)`
},
  {
    id: 'zdr-16',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Diabetologie v akutní medicíně – ČLS JEP',
      explanation: `Při hypoglykémii trpí mozkové buňky kritickým nedostatkem glukózy. Podání tekutin bezvědomému hrozí aspirací a udušením; v bezvědomí pomůže nitrožilní glukóza aplikovaná lékařem. (Právní úprava: Diabetologie v akutní medicíně – ČLS JEP)`
},
  {
    id: 'zdr-17',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Kardiologie pro záchranáře – Česká kardiologická společnost',
      explanation: `Ischémie srdečního svalu vyžaduje okamžitý klidový režim v polosedě, uvolnění těsného oděvu, zákaz jakékoliv fyzické námahy a neodkladné volání linky 155. (Právní úprava: Kardiologie pro záchranáře – Česká kardiologická společnost)`
},
  {
    id: 'zdr-18',
    subject: 'Zdravověda a první pomoc',
...
},
  {
    ...
    source: 'Oftalmologie a urgentní péče v traumatologii',
      explanation: `Vytahování tělesa laickým zachráncem vede k výhřezu očních struktur a trvalé slepotě. Zakrytí obou očí eliminuje zrcadlový pohyb očních bulbů. (Právní úprava: Oftalmologie a urgentní péče v traumatologii)`
},
  {
    id: 'zdr-21',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Standardy operačního řízení ZZS ČR a směrnice VS ČR',
      explanation: `Strukturované hlášení umožňuje operátorovi vyslat adekvátní posádku (RLP s lékařem vs RZP) a navigovat personál k místu zásahu v rozsáhlém vězeňském areálu. (Právní úprava: Standardy operačního řízení ZZS ČR a směrnice VS ČR)`
},
  {
    id: 'zdr-22',
    subject: 'Zdravověda a první pomoc',
    ...
    source: 'Standardy první pomoci Českého červeného kříže',
      explanation: `Protišoková opatření 5T stabilizují mikrocirkulaci a brání prohloubení centralizace oběhu před příjezdem záchranné služby. (Právní úprava: Standardy první pomoci Českého červeného kříže)`
}
  ,
  ...
  // 32. Anafylaktický šok
  {
    ...
    source: 'Doporučené postupy ERC (Evropská resuscitační rada)',
      explanation: `Anafylaxe je život ohrožující stav vyžadující okamžitou aplikaci adrenalinu (EpiPen), který rozšíří dýchací cesty a zvedne krevní tlak. (Právní úprava: Doporučené postupy ERC (Evropská resuscitační rada))`
},
  // 33. Popáleniny
  {
    id: 'zdr-25',
