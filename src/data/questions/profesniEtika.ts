...
export const profesniEtikaQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Svoboda volby existuje pouze v oblasti soukromého života, zatímco při výkonu státní správy je rozhodování determinováno bez možnosti etické sebereflexe a odpovědnosti.'
    ],
    correctOption: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Nemají žádný společný základ, protože mravnost zkoumá pouze biologické reflexy, morálka tržní vztahy a právo represivní techniky vězeňství.'
    ],
    correctOption: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Vnitřní sankce jsou somatické projevy stresu a nemoci, zatímco vnější sankce jsou pouze pozitivní stimuly ve formě služebního povýšení a medailí.',
      'Všechny sankce v normativních systémech mají ze své podstaty pouze negativní a represivní charakter; pozitivní sankce etická teorie neuznává.'
    ],
    correctOption: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Využívá pouze neformální vnitřní sankce svědomí a morální apele na čest a bezúhonnost občana bez možnosti mocenského donucení.',
      'Využívá výhradně nepsané etické zvyklosti a společenský posměch komunity při zjištění protiprávního chování pachatele.',
      'Využívá pouze pozitivní finanční pobídky a dotace pro bezúhonné občany, přičemž negativní sankce jsou v právním státě zakázány.'
    ],
    correctOption: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Význam má pouze pro příslušníky justičních orgánů, zatímco u pachatelů trestné činnosti rozvoj právního vědomí zvyšuje riziko sofistikovanější kriminality.'
    ],
    correctOption: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Katalog obsahuje pouze jmenný seznam vedoucích funkcionářů podléhajících povinnému bezpečnostnímu prověření NBÚ na stupeň Tajné.',
  ...
  },
  {
    ...
    options: [
      ...
      'Slouží pouze jako formální deklarace v etickém kodexu, ke které je žádoucí přistupovat pragmaticky a uplatňovat ji jen při přímé kontrole nadřízenými.',
  ...
  },
  {
    ...
    options: [
      ...
      'Etika je souborem státem vynutitelných pravidel obsažených ve Sbírce zákonů, zatímco právo představuje pouze nezávazná filozofická doporučení.',
  ...
  },
  {
    ...
    options: [
      ...
      'Vyvíjí se pouze mechanickým opisováním paragrafů zákonů při absolvování kurzu základní odborné přípravy.'
    ],
    correctOption: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Povinnost vzdělávání personálu v lidských právech z mezinárodních dokumentů nevyplývá, je pouze fakultativním doporučením.'
    ],
    correctOption: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Účast je povinná pouze pro prvotrestané odsouzené mladší 21 let jako součást eticko-výchovného působení sboru.',
      'Duchovní péče je ve věznicích ČR povolena pouze v případě, že si odsouzený hradí veškeré náklady na kaplana ze svých úspor.'
    ],
    correctOption: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Oznámit tuto skutečnost pouze dotčené osobě a dohodnout se s ní na utajení jejich vztahu před ostatními kolegy ve směně.'
    ],
    correctOption: 0,
