...
export const pravoQuestions: Question[] = [
  ...
  // 8. Trestní odpovědnost pokusu a přípravy TČ
  {
    ...
    options: [
              ...
              `Pokus je trestný výhradně poloviční trestní sazbou odnětí svobody a příprava je postihována výhradně jako přestupek proti veřejnému pořádku v příslušném správním řízení.`,
  ...
  // 9. Odpovědnost mládeže podle zákona č. 218/2003 Sb.
  {
    ...
    options: [
              ...
              `Děti do 15 let i mladiství do 18 let jsou zcela trestně neodpovědní; jejich jednání se posuzuje výhradně jako přestupek a ukládají se jim výhradně kárná opatření orgánem sociálně-právní ochrany dětí (OSPOD).`,
              `Děti do 15 let páchají provinění a jsou trestány v trestním řízení soudem pro mládež, zatímco mladiství (15–18 let) páchají činy jinak trestné a mohou jim být ukládána výhradně ochranná léčení a ústavní výchova.`
            ],
    correctOption: 0,
  ...
  // 14. Zavinění (úmysl a nedbalost)
  {
    ...
    options: [
              `Úmysl se dělí výhradně na plánovaný (předem promyšlený po zralé úvaze) a afektový (náhlé hnutí mysli). Nedbalost se dělí výhradně na lehkou (omluvitelnou) a těžkou (spojenou s hrubým porušením pracovní kázně).`,
  ...
  // 17. Spolupachatel trestného činu
  {
    ...
    options: [
              ...
              `Spolupachatelství nastává při spáchání činu nejméně třemi osobami, přičemž každý odpovídá výhradně za jím způsobený poměrný díl škody a excesem je dobrovolné vzdání se trestné činnosti před policií.`
            ],
    correctOption: 0,
  ...
  // 25. Korupce (úplatkářství)
  {
    ...
    options: [
              ...
              `Úplatek je výhradně hotovost v české měně přesahující 100 000 Kč předaná osobně. TČ úplatkářství tvoří výhradně přijetí peněz úřední osobou, zatímco poskytnutí peněz občanem je beztrestné.`,
              `Úplatek je jakýkoliv dar věnovaný státnímu orgánu. Úplatkářství zahrnuje výhradně zneužití pravomoci soudce a státního zástupce, přičemž nepřímé úplatkářství a slib úplatku trestní zákoník nepostihuje.`,
              `Úplatek je obchodní provize dohodnutá v písemné smlouvě. Trestnými činy jsou výhradně neoprávněné podnikání, porušení předpisů o pravidlech hospodářské soutěže a zkrácení daně.`
            ],
    correctOption: 0,
  ...
  // 39. Subjekty trestního řízení
  {
    ...
    options: [
              `Subjekty jsou výhradně očití svědci a přizvaní soudní znalci, zatímco stranami trestního řízení jsou výhradně příslušníci vězeňské eskorty a justiční stráže.`,
              `Subjektem trestního řízení je výhradně předseda senátu krajského soudu a stranami jsou vyšetřovatelé Policie ČR podávající zprávu o průběhu vyšetřování.`,
              ...
              `Subjekty trestního řízení jsou výhradně příslušníci a občanští zaměstnanci Vězeňské služby ČR zajišťující ostrahu obviněného v průběhu soudního líčení.`
            ],
    correctOption: 2,
  ...
  // 41. Postavení státního zástupce v trestním řízení
  {
    ...
    options: [
              ...
              `Má výhradně poradní hlas bez možnosti vydávat závazné pokyny policii, přičemž o podání obžaloby rozhoduje policejní vyšetřovatel samostatně.`
            ],
    correctOption: 0,
  ...
  // 46. Propuštění z výkonu vazby a nahrazení vazby
  {
    ...
    options: [
              `Propuštěn může být výhradně po složení nevratného administrativního poplatku ve výši 500 000 Kč přímo na účet ředitele vazební věznice, přičemž náhradní instituty zákon nepřipouští.`,
  ...
  // 51. Probační a mediační služba
  {
    ...
    options: [
              `Hlavním cílem PMS je výhradně bezplatné právní zastupování pachatelů před soudem. Podílí se výhradně na přípravném řízení před podáním obžaloby a nahrazuje činnost advokátů.`,
              ...
              `PMS se zaměřuje výhradně na ochranu obětí trestných činů a poskytování finanční kompenzace od státu; s pachateli zásadně nepracuje, aby nedošlo ke střetu zájmů.`
            ],
    correctOption: 2,
  ...
  // 52. Druhy trestů odnětí svobody
  {
    ...
    options: [
              ...
              `Existuje výhradně jeden typ věznice s jednotným režimem pro všechny odsouzené, protože ústava zaručuje rovnost občanů před zákonem i během výkonu trestu.`,
  ...
  // 55. Rozdíl mezi TČ a Přestupkem
  {
    ...
    options: [
              `Obě kategorie jsou totožné, rozdíl je výhradně v terminologii starých a nových zákonů; o obou rozhoduje výhradně soud v trestním řízení a ukládá stejné tresty.`,
              `Přestupkem je výhradně neúmyslné (nedbalostní) jednání řešené Policií ČR na ulici, zatímco trestným činem je výhradně úmyslné násilí páchané organizovanými skupinami.`,
