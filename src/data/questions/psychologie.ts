...
export const psychologieQuestions: Question[] = [
  {
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 3',
      explanation: `Psychologie se řadí mezi společenské vědy. Zkoumá člověka ze dvou hledisek: vnitřního (prožívání – uvědomované sebepozorováním) a vnějšího (chování a jednání – navenek pozorovatelná a měřitelná aktivita). (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 3)`
},
  {
    id: 'psy-02',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 7',
      explanation: `Psychické jevy tvoří integrovaný celek osobnosti. Poznávací procesy zahrnují vnímání, představivost, fantazii, myšlení a řeč; paměťové procesy zahrnují zapamatování, uchování a vybavení. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 7)`
},
  {
    id: 'psy-03',
    subject: 'Psychologie',
    ...
    options: [
              `V širším slova smyslu je osobnost souhrnem biologických reflexů a vrozených instinktů. V užším slova smyslu představuje výhradně dospělého jedince plně způsobilého k právním úkonům s dokončeným procesem socializace.`,
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 7, 9',
      explanation: `Osobnost představuje charakteristické vzorce myšlení, emocí a chování, které určují osobní styl jedince a ovlivňují jeho interakce s prostředím. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 7, 9)`
},
  {
    id: 'psy-04',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 7, 55',
      explanation: `Současná věda odmítá extrémy (např. lombrosiánské přeceňování vrozeného zločince i behavioristické přeceňování všemocnosti výchovy) a chápe osobnost jako syntézu biologických vloh a sociálního utváření. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 7, 55)`
},
  {
    id: 'psy-05',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 11–12',
      explanation: `Socializace je celoživotní proces sociálního učení a je nutnou podmínkou individualizace osobnosti. Klíčovými institucemi socializace jsou rodina, škola, vrstevníci a pracovní kolektiv. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 11–12)`
},
  {
    id: 'psy-06',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 13',
      explanation: `Dobře adaptovaný člověk je citově zralý, reálně hodnotí své možnosti, ovládá své afekty a identifikuje se se sociálními rolemi odpovídajícími věku a postavení. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 13)`
},
  {
    id: 'psy-07',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 12–14',
      explanation: `Poruchy chování v dětském věku (lži, záškoláctví, krádeže, útěky) se dělí dle nebezpečnosti na disociální, asociální a antisociální a jsou častým předstupněm dospělé kriminality. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 12–14)`
},
  {
    id: 'psy-08',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 15, 17',
      explanation: `Dále skupiny vykazují vnitřní dynamiku (vůdčí osoby, klima, kontakty) a rysy jako intimita, organizace, propustnost, disciplína a soudržnost. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 15, 17)`
},
  {
    id: 'psy-09',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 16, 18–19',
      explanation: `Člověk se v rodině ocitá bez své vůle, přesto je pro něj po celý život nepostradatelným prostředím. Narušení vztahů v rodině mívá těžké následky na psychiku a vývoj. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 16, 18–19)`
},
  {
    id: 'psy-10',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 24–25',
      explanation: `Komunikace probíhá v rovině věcné (obsah sdělení) a rovině vztahové (vztah mezi komunikujícími). Záměna rovin nebo „čtení myšlenek“ vede k poruchám komunikace. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 24–25)`
},
  {
    id: 'psy-11',
    subject: 'Psychologie',
...
},
  {
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 25, 62',
      explanation: `Ve vězeňství vznikají silné komunikační bariéry zejména při práci s cizinci (jazyk, odlišné kulturní vzorce) nebo u osob s mentálním deficitem a poruchami osobnosti. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 25, 62)`
},
  {
    id: 'psy-13',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 19–20',
      explanation: `Mezi další chyby patří: chyba prostředí (figura a pozadí), efekt setrvačnosti, první dojem, estetický stereotyp a soukromá teorie osobnosti. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 19–20)`
},
  {
    id: 'psy-14',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 20, 22–23',
      explanation: `Asertivita chrání příslušníka před manipulací, pocity viny a pomáhá řešit drobné konflikty bez citového zainteresování a bez narušení lidské důstojnosti. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 20, 22–23)`
},
  {
    id: 'psy-15',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 29–30',
      explanation: `Akce davu se vyznačuje psychickou nákazou (davová psychóza), sugescí a nápodobou. Fáze davu: 1. Formování (roste počet a emoce), 2. Vzrůst emocionality (přesvědčení o všemocnosti a beztrestnosti). (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 29–30)`
},
  {
    id: 'psy-16',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 30–31',
      explanation: `Startéři mívají nízkou úroveň právního vědomí a deformovaný hodnotový systém. Jejich včasná eliminace a izolace zamezí eskalaci nepokojů a vzniku davové psychózy. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 30–31)`
},
  {
    id: 'psy-17',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 38, 40, 45',
      explanation: `Rozvoj závislosti probíhá v řetězci: 1. První kontakt → 2. Pokus (experiment) → 3. Zneužití (abúzus) → 4. Závislost. Na vzniku se podílí typ drogy, osobnost, sociální prostředí a spouštěcí podnět. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 38, 40, 45)`
},
  {
    id: 'psy-18',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 41, 42, 43, 44, 45',
      explanation: `Zkouška reakce zornic na světlo a jejich šířka je základním orientačním znakem pro příslušníka při podezření na intoxikaci vězněné osoby. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 41, 42, 43, 44, 45)`
},
  {
    id: 'psy-19',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 40, 45',
      explanation: `Uživatelé těkavých látek (toluen, ředidla) navíc často inhalují v uzavřeném prostoru (pod dekou, s igelitovým sáčkem na hlavě), což riziko asfyxie ještě násobí. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 40, 45)`
},
  {
    id: 'psy-20',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 38–39',
      explanation: `Závislost vede k degradaci osobnosti, ztrátě zájmů, rozpadu sociálních vazeb a kriminálnímu jednání za účelem obstarání drogy. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 38–39)`
},
  {
    id: 'psy-21',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 47–48',
      explanation: `Nelátkové závislosti vykazují stejné znaky jako látkové (význačnost, změny nálady, růst tolerance, abstinenční tenze, konflikty a relapsy). (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 47–48)`
},
  {
    id: 'psy-22',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 46–47',
      explanation: `Pojem „debakl“ v konečném stadiu znamená stav bezvýchodnosti: bez alkoholu to dál nejde (těžký absťák), ale s alkoholem už také ne (orgánový a osobnostní kolaps). (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 46–47)`
},
  {
    id: 'psy-23',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 48–49',
      explanation: `Patologický hráč splňuje 6 znaků: význačnost, změny nálady, růst tolerance, abstinenční příznaky (neklid mizí zahájením hry), konflikty a relapsy. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 48–49)`
},
  {
    id: 'psy-24',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 35–38',
      explanation: `Při frustraci nastupují obranné mechanismy: vytěsnění, potlačení, projekce, agrese, racionalizace, kompenzace, regrese (návrat do dětského chování) a fantazie. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 35–38)`
},
  {
    id: 'psy-25',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 5, 52',
      explanation: `Forenzní psychologie aplikuje psychologické poznatky do všech fází trestního řízení, výkonu vazby, výkonu trestu i následné péče. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 5, 52)`
},
  {
    id: 'psy-26',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 52–55',
      explanation: `Znalost typologie umožňuje personálu volit odpovídající přístup při zacházení a bezpečnostních opatřeních. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 52–55)`
},
  {
    id: 'psy-27',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 55–56',
      explanation: `Kriminalita je výsledkem multidisciplinárního působení biologických, psychologických i sociálních faktorů. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 55–56)`
},
  {
    id: 'psy-28',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 65–66',
      explanation: `S délkou pobytu ve vazbě klesá věrohodnost výpovědi obviněného (nárůst obranných mechanismů racionalizace a projekce). Pozitivně působí volná vazba, kontakt s obhájcem a krizová intervence. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 65–66)`
},
  {
    id: 'psy-29',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 57, 67',
      explanation: `Jiří Čepelák (významný odborník VÚPen) zdůraznil nutnost odborné diferenciace a zacházení; neodborné vedení vede k prohloubení patologických rysů osobnosti. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 57, 67)`
},
  {
    id: 'psy-30',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 60–62',
      explanation: `Krize z uvěznění je deprivační situace vzniklá ztrátou svobody, rozpadem časoprostorové dimenze a ztrátou kontroly nad vlastním životem. Cizinci jí trpí ve větší míře. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 60–62)`
},
  {
    id: 'psy-31',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 70, 74',
      explanation: `Šikana má vysokou latenci, oběti se bojí označení za „bonzáka“. VS ČR provádí preventivní zrakové prohlídky, lékařské kontroly a čtvrtletní vyhodnocování komisí za účasti vedení. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 70, 74)`
},
  {
    id: 'psy-32',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 57, 62',
      explanation: `Historicky významnou roli sehrál Výzkumný ústav penologický v Praze (VÚPen). Dnes jsou psychologové civilními specialisty působícími ve všech věznicích a vazebních věznicích. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 57, 62)`
},
  {
    id: 'psy-33',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 74–76',
      explanation: `Rizikové faktory suicidia: pokusy v anamnéze či rodině, beznaděj, chronická nemoc, abúzus alkoholu/drog, osamělost, věk nad 40 let a mužské pohlaví. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 74–76)`
},
  {
    id: 'psy-34',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 36–37, 72',
      explanation: `Konflikty je třeba řešit věcně a včas, ne je oddalovat. Příslušník musí jednat profesionálně a nenechat se strhnout k emocionální nebo verbální agresi. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 36–37, 72)`
},
  {
    id: 'psy-35',
    subject: 'Psychologie',
    ...
    source: 'Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 31–32, 54, 70',
      explanation: `V kriminální populaci tvoří psychopati cca 30 % (u recidivistů ještě více). Disociální a emočně nestabilní jedinci mají navíc zvýšené riziko abúzu návykových látek, které agresivitu dále eskalují. (Právní úprava: Učební texty předmětu Psychologie, Akademie VS ČR 2023, str. 31–32, 54, 70)`
}
  ,
  // 46. Krizová komunikace - Deeskalace
  {
    ...
    source: 'Metodika krizové intervence VS ČR',
      explanation: `Verbální deeskalace je preferovaným prvotním postupem u afektivní agrese (nikoli instrumentální). Cílem je zklidnit fyziologické nabuzení útočníka (získat kontrolu nad situací). (Právní úprava: Metodika krizové intervence VS ČR)`
},
  // 47. Stockholm syndrom
  {
    ...
    source: 'Základy psychologie pro bezpečnostní sbory',
      explanation: `Tato reakce komplikuje záchranné operace, protože oběť může chránit únosce nebo odmítat pomoc policie. Vzniká z prožitého ohrožení života a následné "vděčnosti", že ji pachatel nezabil. (Právní úprava: Základy psychologie pro bezpečnostní sbory)`
},
  // 48. Psychohygiena
  {
    id: 'psy-38',
    ...
    source: 'Psychologie pro výkon služby (Metodika GŘ VS ČR)',
      explanation: `Syndrom vyhoření (Burnout) hrozí u pomáhajících a bezpečnostních profesí. Aktivní psychohygiena a schopnost zpracovat zátěž (debriefing) jsou klíčové pro dlouhodobé duševní zdraví. (Právní úprava: Psychologie pro výkon služby (Metodika GŘ VS ČR))`
},
  // 49. Manipulace vězni
  {
    id: 'psy-39',
    ...
    source: 'Penitenciární psychologie',
      explanation: `Manipulace je účelové jednání (často u psychopatických rysů osobnosti vězňů). Vězeň se snaží narušit profesionální odstup dozorce ("my versus oni") a zatáhnout ho do neformálního vztahu. (Právní úprava: Penitenciární psychologie)`
},
